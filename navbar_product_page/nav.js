    ...
    <nav class="menu">
      ...
      <ul class="menu-main">
        ...
        <li class="menu-item-has-children">
          <a href="#">TVs & Appliances<i class="fa fa-angle-down"></i></a>
          <div class="sub-menu mega-menu mega-menu-column-4">
            <div class="list-item">
              ...
              <ul>
                ...
                <li><a href="#"> iFFALCON by TCL </a></li>
                <li><a href="#"> LG </a></li>
            ...
            <div class="list-item">
              <h4 class="title">Washing Machine,Inverter & More</h4>
              <ul>
            ...
            <div class="list-item">
              <h4 class="title">Small Home Appliances</h4>
              <ul>
        ...
        <li class="menu-item-has-children">
          <a href="#">Beauty & More<i class="fa fa-angle-down"></i></a>
          <div class="sub-menu mega-menu mega-menu-column-4">
            <div class="list-item">
...
function productNavbarJS() {
  const menu = document.querySelector(".menu");
  const menuMain = menu.querySelector(".menu-main");
  const goBack = menu.querySelector(".go-back");
  const menuTrigger = document.querySelector(".layer");
...
export { productNavbarHtml, productNavbarJS };